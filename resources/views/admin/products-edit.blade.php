        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.products.update')}}">
            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product name" name="name" tabindex="0" value="{{ $products->name}}" aria-required="true" required="">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product slug" name="slug" tabindex="0" value="{{ $products->slug}}" aria-required="true" required="">
                    <div class="text-tiny">Do not exceed 100 characters when entering the
                        product name.</div>
                </fieldset>
                ...
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" aria-required="true" required="description">{{ $products->description}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the
                        product name.</div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item" id="imgpreview" >
                            <img src="{{asset('uploads/products')}}/{{$products->image}}" class="effect8" alt="{{$products->name}}" />
