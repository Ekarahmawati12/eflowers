      ...
      <div class="row">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="{{asset('uploads/products')}}/{{$products->image}}" width="674" height="674"  alt="" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
            ...
            <form method="POST" action="{{route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id', $products->id)->first()->rowId])}}" id="frm-remove-item">
              @csrf
              @method('DELETE')
          ...
          <div class="swiper-wrapper">
            @foreach ($rproducts as $rproduct)
              ...
              <div class="pc__img-wrapper">
                <a href="{{ route('shop.products.details', ['products_slug' => $rproduct->slug]) }}">
